...
public class PauseMenu extends GameObject {
    ...
    public void drawExitButton(Graphics2D g2d, int x, int y, int mouseX, int mouseY) {
        ...
        if (isHovered) {
            ...
            g2d.fillRect(x + 2, y + 2, buttonWidth - 4, thickness); // Inner Top
            g2d.fillRect(x + 2, y + 2, thickness, buttonHeight - 4); // Inner Left

            //bottom and right shadows
            g2d.setColor(new Color(57, 59, 70));
            g2d.fillRect(x + 2, y + buttonHeight - 2 - thickness, buttonWidth - 4, thickness); // Inner Bottom
            g2d.fillRect(x + buttonWidth - 2 - thickness, y + 2, thickness, buttonHeight - 4); // Inner Right
        } else {
            //top and left shadows
